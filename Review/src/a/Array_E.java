...
// == 자바 배열 (정적) == //
// : 한 번 생성되면 크기 변경 X
// : 크기 변경이 필요한 경우, 변경된 크기의 배열을 생성하여 요소 값을 복사 
public class Array_E {
	public static void main(String[] args) {
		...
		// +) collection Framework의 모든 클래스 내부에서는 개체 구조 만을 다룸
		//        : 기본 타입 사용X
...
//		int b = null;
		...
		// == ArryaList 생성 == // 
		// : ArryaList<데이터타입> 변수명 = new ArrayList<>(초기용량);
...
//		int[] numberArray = new int[];
		...
		// : 초기 용량을 미지정 시 - 기본값 10
		// > 해당 용량은 배열 사용시 담겨있는 요소의 크기만큼만 측정
