...
//		System.out.println(출력하고자 하는 변수 또는 상수 또는 데이터 값);
		...
		// 실행 단축키로 자동 완성
		System.out.println("안녕하세요:)"); // ln : line(주어진 값을 콘솔에 출력하고 바꿈)
		
		System.out.println("안녕"); // 줄 복사 단축키 : crtl + alt  + 방향키 
		System.out.println("하세요"); 
		System.out.println("반갑습니다"); 
		System.out.println(20250728); 
	    ...
	    // 개행문자(Enter) + 버퍼
	    // : nextLine() + nextDouble()의 경우
	    // - 버퍼에 개행 문자가 입력으로 처리되는 문제가 발생
	    // - 처리방법
	    //          : nextLine()의 입력 메서드 호출로 버퍼의 데이터를 사용(Enter처리)
