...
public class D {
	public static void main(String[] args) {
		/*
		 ...
		 1. 데이터 타입 종류
		 1) 기본 타입 
		        - 변수 선언 시 해당되는 자료형의 크기 만큼 메로리가 할당
		        - 실질적인 데이터가 저장
		...
		// 1) 기본타입 (자료형 - 8개)
		// byte(1), shorta(2), long(8), float(4)
...
//		String WelcomeMessge = '만나서 반갑습니다 :)'
	    ...
	    // == 데이터 타입 정리 == 
	    // 정리 : byte < short < int(Integer) < long
	    // 실수 : folat < double
	    // 문자 : char(Character)
	    // 논리  : boolean
	    ...
	    // 학생 이름(String)
	    String studentName = "장인규";
	    // >> 하나의 스코프({}) 내에서 동일한 변수명 사용이 불가!
	    int studentAge = 27;
	    double height = 170.1;
