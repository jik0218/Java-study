...
public class G_Operrator {
	public static void main(String[] args) {
		
		// === 연산자(Operation)
		// : 프로그램에서 데이터를 조가하거나 계산
		...
		// : 좌항과 우항을 비교한 결과를 논리(bloolean) 값으로 변환
		// <, >, <=, =>, ==, !=(불일치)
		...
		// 조건식(논리의 값이 반환) ? 조건식이 참인 경우 변환 : 조건식이 거짓인 경우 반환
		
		int age = 18;
		String drink = age > 19 ? "맥주" : "오렌지주스";
		System.out.println(drink + "을 마십니다.");
